...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Image classification a fully-connected NN}
...
\begin{itemize}
\item Two extra output are added
...
\begin{itemize}
\item \alert{Skip connection} help backpropagation
\end{itemize}
...
\frame{
  ...
  \begin{block}{Comments}
    ...
    \item \emph{Keras} is a very easy to use interface to Tensorflow.
    \end{itemize}
