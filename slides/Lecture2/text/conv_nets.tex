...
\begin{frame}{Correction TP 1}
  ...
  \item Comparaison: besoin d'une base de \alert{test}. Quantification.
  \end{itemize}
...
\frame{
  ...
  \begin{itemize}
  \item 2011: first super-human performance, IJCNN 2011 traffic sign recognition contest \cite{stallkamp_german_2011, ciresan_committee_2011}
    \begin{figure}[ht]
      \centering
...
\frame{
  ...
  \begin{alertblock}<2->{First task: image classification!}
    In the following, we will focus on image classification.
  \end{alertblock}
